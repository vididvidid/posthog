...
from ..models.evaluations import EvaluationConfig
...
class EvaluationConfigFilter(django_filters.FilterSet):
...
class EvaluationConfigViewSet(TeamAndOrgViewSetMixin, ForbidDestroyModel, viewsets.ModelViewSet):
    scope_object = "evaluation_config"
    ...
    def safely_get_queryset(self, queryset: QuerySet[EvaluationConfig]) -> QuerySet[EvaluationConfig]:
        return (
            queryset.filter(
